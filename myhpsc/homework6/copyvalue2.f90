...
program copyvalue2
    ...
    if (proc_num .EQ. num_procs-1) then
        i = 55
        print '("Process ",i3," sending      i = ",i3," to process   ", i3)', proc_num, i,num_procs-2
        ...
        print '("Process ",i3," receives     i = ",i3, " from process ",i3)', proc_num, i, proc_num+1
        print '("Process ",i3," sends        i = ",i3, " to process   ",i3)', proc_num, i-1, proc_num-1
        ...
        print '("Process ",i3," ends up with i = ",i3," from process ",i3)', proc_num, i, proc_num+1
      endif
